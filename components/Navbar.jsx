                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex="0" className="menu menu-compact space-y-2 dropdown-content mt-3 p-2 shadow bg-light rounded-box w-52">
                            ...
                            {loggedIn === true
                                ...
                                <>
                                    <li>
                                        <Link className={pageName === 'Login' ? 'font-bold text-lg bg-accent rounded-xl text-black' : 'text-drk'} href="login" >Login</Link>
                                        {
                                            provider && Object.values(provider).map((provider)=>(
                                                <button className="btn" key={provider.name} type="button" onClick={()=>{signIn(provider.id)}}>
                                                    {provider.name}
                                                </button>
                                            ))
                                        }
